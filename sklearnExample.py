...
w = clf.coef_[0]#get all w shuzhi
a = -w[0]/w[1]#get k xielv
xx = np.linspace(-5, 5)
yy = a*xx - (clf.intercept_[0])/w[1]#clf.intercept_[0]w3

# plot the parallels to the separating hyperplane that pass through the support vectors
b = clf.support_vectors_[0]#get zhichixiangliang de jieju
